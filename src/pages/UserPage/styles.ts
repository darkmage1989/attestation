...
export const DynamicPageBox = styled.main`
  display: flex;
  ...
  gap: 30px;
`;
export const DynamicPageSpan = styled.span`
  font-size: 40px;
`;
export const DynamicPageButton = styled.button`
...
`;
export const DynamicPageLink = styled(Link)`
text-decoration:none;
color: black;
`
